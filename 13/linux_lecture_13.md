...
Якимось чином, у контейнері оболонка має ідентифікатор процесу 1 (пам'ятайте, на звичайній системі це *init*), і нічого крім виконання процесу, який ви запустили.
