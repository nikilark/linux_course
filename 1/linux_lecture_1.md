# Лінукс. Лекція 1. Вступ
## Що таке Linux?
Linux є відкритою операційною системою, яка базується на ядрі Linux. Вона була створена Лінусом Торвальдсом у 1991 році як альтернатива комерційним операційним системам, таким як Windows або macOS. Однією з основних особливостей Linux є те, що він є вільним програмним забезпеченням, тобто його вихідний код відкритий для перегляду, модифікації та розповсюдження.
...
Торвальдс почав працювати над ядром операційної системи, яке надалі стало відомим як Linux. Він використовував ряд інших вільних програм, щоб створити повноцінну операційну систему, яка могла б працювати на персональних комп'ютерах. Одним з головних принципів, на яких ґрунтувався Linux, була відкритість і доступність вихідного коду для спільного використання та удосконалення.
...
Уже у 1992 році Linux випущений як вільне програмне забезпечення і був доступний для широкого кола користувачів. З часом Лінус Торвальдс став головним розробником ядра Linux, а інші розробники з усього світу приєдналися до проєкту, допомагаючи в удосконаленні й розвитку операційної системи.

Сьогодні Linux є однією з найпопулярніших операційних систем у світі. Він використовується на серверах, вбудованих пристроях, суперкомп'ютерах та навіть на десктопних комп'ютерах. Його успіх полягає у відкритому коді, стабільності та безпеці, а також у можливостях налаштування під різні потреби користувачів.

![Unix timeline](images/unix_timeline.jpg)

## Де можна зустріти Linux?
На цей час персональні комп'ютери з операційною системою Linux складають невелику частку ринку, що оцінюється від 1% до 2%, залежно від джерела статистики та регіону. Основні операційні системи для персональних комп'ютерів - Windows та macOS - є більш поширеними серед звичайних користувачів.

Проте Linux займає значно більшу частку на ринку серверів і вбудованих систем. У сегменті серверів Linux є домінуючим гравцем і використовується на багатьох великих інтернет-платформах, таких як Google, Facebook, Amazon і т. д. Його висока стабільність, безпека й ефективність робить його вигідним вибором для серверних середовищ.
...
- Відомий своєю стабільністю та надійністю.
- Має велику кількість пакунків програмного забезпечення у своїх репозиторіях.
- Використовує різні оболонки користувача, такі як GNOME, KDE, Xfce тощо.
...
- Орієнтований на досвідчених користувачів та має простий та лаконічний дизайн.
- Використовує принцип "будуй сам", де користувачі самі налаштовують свою систему.
- Має велику колекцію пакунків у своїх репозиторіях та AUR.
...
- Орієнтований на зручність та легкість використання для початківців.
- Має власну оболонку користувача Cinnamon, яка нагадує класичний стиль робочого столу.
- Містить багато корисних програм за замовчуванням.
...
## Термінал
У Linux термінал (або консоль) - це текстове вікно, яке дозволяє користувачеві взаємодіяти з операційною системою за допомогою команд. Термінал дає доступ до командного рядка, де можна вводити різноманітні команди для виконання різних завдань, таких як керування файлами, запуск програм, адміністрування системи тощо.
