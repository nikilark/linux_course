...
3. **Низька продуктивність запису**: Запис даних відбувається на основний диск та диск парності, що може створювати буттялкування на диску парності у високоінтенсивних системах запису.
